I believe that it is currently possible to establish algorithms in dependently typed languages such that they are what you and I might intuitively think of as "executable thoughts" (i.e., have the same soundness and completeness you would expect from an algorithm built into powered circuitry). I also believe that it is currently possible to establish proof of an algorithm's intent by covering the surface area of said "intent" with "enough testing."

In case I haven't already made it clear, this is not a place for people who believe that "most sci-fi is just fiction," nor is it a place for people who derive their foundations of scientific proof such that "mathematics is the one and only Ring of Power." If you find yourself in any such camp, and you want to keep your feet firmly in such a camp, it's probably best that you simply find some form of proven entities in Elsweyr.
